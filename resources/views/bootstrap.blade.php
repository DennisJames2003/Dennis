...
<head>
    ...
    <style <!DOCTYPE html>
        ...
        href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.6.0/font/bootstrap-icons.css">
            ...
            <style>
                .bg-purple{
            background-color: #7533f3 !important;
        }
        #main a{
            color: gray;
        }
        ...
        <nav class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
            ...
            <div class="container py-2 px-4">
                ...
                <div class="offcanvas offcanvas-end bg-purple" id="offcanvasNavbar">
                    ...
                    <div class="offcanvas-body pt-0 px-4">
                        <hr class="d-ad-none text-white-50"> <!-- Horizontal Line -->
                        ...
                        <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                            <li class="nav-item col-6 col-md-auto">
                                <a href="#" class="nav-link active"> <i class="bi-github"></i><small class="ms-2 d-md-none">Github</small>
                ...
                <div class="container py-5 px-4">
                    <div class="row">
                        <div class="col-md-5 order-md-2">
                            <img class="img-fluid" src="{{Vite::asset('resources/images/logo-white.svg') }}" alt="main logo">
                        </div>
                        <div class="col-md-7 order-md-1">
                            ...
                            <div class="row">
                                <div class="d-flex flex-colomn flex-md-row">
                                    <button type="button" class="btn bg-purple text-white btn-Ig mb-3 me-md-3 px-3">Get Started</button>
                                    <button type="button" class="btn btn-outline-dark btn-Ig mb-3 px-4 py-3">Download</button>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <a class="icon-link icon-link-hover lead fw-semibold mb-5" href="#">
                                Get Bootstrap Icons <i class="bi bi-arrow-right mb-2"></i>
                            </a>
                        </div>
                        <div class="col-lg-6">
            ...
            <div id="bs-themes">
                ...
                <div class="container py-5 px-4">
                    <div class="row">
                        <div class="col-lg-6"> <div class="mb-3 mt-5">
                        ...
                        <a class="icon-link icon-link-hover lead fw-semibold mb-5" href="#">
                            rowse Bootstrap Themes
                        <i class="bi bi-arrow-right mb-2"></i>
                        </a>
                        </div>
                        <div class="col-lg-6">
                            <img class="img-fluid" src="{{Vite::asset('resources/images/bs-themes') }}" alt="Bootstrap Themes">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="footer" class="bg-light py-5">
                <!-- Container -->
                <div class="container py-5 px-4"> <div class="row">
                    <div class="col-lg-3 mb-5">
                        ...
                        <div class="col-6 col-lg-2 offset-1g-1 mb-5">
                        <h5>Link</h5>
    ...
    <div id="footer" class="bg-light py-5">
        ...
        <div class="container py-5 px-4"> <div class="row">
            <div class="col-lg-3 mb-5">
                <a href="#" class="logo text-decoration-none">
                    <div class="d-flex">
                        <img class="img-fluid" src="images/logo-black.svg" alt="Bootstrap Logo" style="width: 40px;">
                        <div class="fs-5 ms-2 text-black">Bootstrap</div>
                    </div>
                </a>
                <div class="mt-2 text-muted">
